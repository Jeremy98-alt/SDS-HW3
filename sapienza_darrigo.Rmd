...
plot(G.asd.thr, vertex.size = .5, vertex.color = rgb(0,0,1,.2), label.col = "black", curved = TRUE, 
     main = "ASD Association Graph",  sub = "(Threshold only)")
plot(G.td.thr, vertex.size = .5, vertex.color = rgb(0,0,1,.2), label.col = "black", curved = TRUE, 
...
plot(G.asd.no.bonf, vertex.size = .5, vertex.color = rgb(0,0,1,.2), label.col = "black", curved = TRUE, 
     main = "ASD Association Graph",  sub = "(Without Bonferroni's multiplicity adjustment)")
plot(G.td.no.bonf, vertex.size = .5, vertex.color = rgb(0,0,1,.2), label.col = "black", curved = TRUE, 
